...
const obsoleteHomeCopy = {
  ...
  contact: { titles: ["디자인부터 운영까지,\n해온 일을 더 보여드리겠습니다.", "디자인부터 운영까지, 더 이야기할 수 있습니다.", "다양한 실무 경험을 바탕으로 함께 일할 기회를 찾고 있습니다."], descriptions: ["그래픽, 콘텐츠, 커머스, 서비스 화면을 함께 다뤄온 경험이 필요하다면 작업 모음과 경력을 살펴봐 주세요.", "그래픽, 콘텐츠, 커머스, 서비스 화면까지 함께 다뤄온 경험을 작업과 경력으로 정리했습니다."] },
} as const;
