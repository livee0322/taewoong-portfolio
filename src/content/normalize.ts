...
const obsoleteHomeCopy = {
  hero: {
    titles: ["디자인에서 시작해, 기획과 운영까지 경험했습니다", "디자인을 시작으로 다양한 실무를 경험했습니다.", "기획부터 디자인까지", "디자인과 콘텐츠를 만들고,\n서비스 화면까지 직접 확인합니다.", "디자인에서 시작해, 기획과 서비스까지"],
    descriptions: ["상세페이지, 배너, 유튜브 썸네일과 영상 그래픽을 제작했습니다. 제품 촬영과 쇼핑라이브 기획·운영을 경험했고, 최근에는 서비스 기획과 UI/UX, QA 업무도 진행했습니다.", "상세페이지와 배너, 유튜브 썸네일·타이틀·자막같은 디자인 작업부터 쇼핑라이브 촬영과 영상 편집 최근에는 서비스 기획과 UI/UX, QA 등을 진행했습니다.", "상세페이지와 배너, 유튜브 썸네일·타이틀·자막을 만들었습니다. 제품 촬영과 영상, 쇼핑라이브 현장을 거쳐 최근에는 서비스 기획과 UI/UX, QA, 개발 협업을 맡고 있습니다.", "상세페이지와 배너, 유튜브 썸네일·타이틀·자막을 만들었습니다. 촬영과 쇼핑라이브 현장을 거쳐 지금은 서비스 기획, UI/UX, QA까지 함께 다루고 있습니다."],
  },
  about: {
    titles: ["디자인에서 기획·운영까지", "디자인 외에도 다양한 실무를 경험했습니다.", "디자인 뿐만 아니라, 기획까지 같이", "화면 안의 디자인과 촬영 현장의 일을 함께 해봤습니다.", "화면을 만들고, 그 앞뒤의 과정까지 함께 봅니다."],
    descriptions: ["상세페이지와 배너, 썸네일 제작부터 제품 촬영, 영상 편집, 쇼핑라이브 기획과 운영까지 진행했습니다. 이후에는 서비스 기획, UI/UX, QA 업무도 경험했습니다.", "상세페이지와 배너, 유튜브 썸네일·타이틀·자막같은 디자인 작업부터 쇼핑라이브 기획과 최근에는 서비스 기획과 UI/UX, QA 등을 진행했습니다.", "제품을 촬영하고 상세페이지와 배너를 만들었습니다. 영상에서는 썸네일·타이틀·자막을 제작했고, 쇼핑라이브에서는 방송 준비와 현장 운영을 맡았습니다.", "상세페이지, 배너, 썸네일과 영상 그래픽을 만들고 제품 촬영과 쇼핑라이브 현장을 경험했습니다. 최근에는 서비스 기획과 UI/UX, QA까지 맡고 있습니다."],
  },
  projects: { titles: ["대표적으로 진행한 프로젝트를 소개합니다.", "대표적인 네 가지 프로젝트를 정리했습니다.", "지금의 업무 범위를 만든 네 가지 프로젝트입니다."], descriptions: ["개인 프로젝트 LIVBEE부터 쇼핑라이브, 디자인 실무, 앱 출시 QA까지 실제로 맡은 일을 중심으로 소개합니다.", "개인 프로젝트 LIVBEE부터 쇼핑라이브, 디자인 실무, 앱 출시 QA까지 실제로 맡은 역할을 중심으로 정리했습니다."] },
  works: { titles: ["실무에서 제작한 작업을 모았습니다.", "디자인 작업 진행", "실무에서 만든 작업을 모았습니다.", "공개 가능한 실무 작업을 골라 소개합니다.", "실무에서 만든 작업 중 공개 가능한 결과물을 골랐습니다."], descriptions: ["유튜브 썸네일, 영상 타이틀과 자막, 이벤트 그래픽, 쇼핑라이브 배너, 상세페이지 중 공개 가능한 결과물을 골랐습니다.", "유튜브 썸네일, 영상 타이틀과 자막, 이벤트 그래픽, 쇼핑라이브 콘텐츠, 상세페이지 작업을 모았습니다."] },
  career: { titles: ["2019년부터 다양한 디자인과 콘텐츠 업무를 경험했습니다.", "2019년 제품 디자인부터 지금의 서비스 기획까지."], descriptions: ["회사와 팀이 바뀔 때마다 맡은 역할도 달라졌습니다. 아래에 실제 경력 순서와 각 시기에 담당한 일을 적었습니다.", "회사와 역할이 바뀌면서 맡는 일도 넓어졌습니다. 실제 경력 순서와 각 시기의 주요 업무를 정리했습니다."] },
  workflow: { titles: ["더 효율적인 작업 방식", "업무에 필요한 방법을 찾아 직접 진행합니다.", "목적을 정리하고, 만든 뒤에는 실제 화면에서 확인합니다."], descriptions: ["디자인 툴뿐 아니라 업무 관리, 파일 관리, AI 도구 등 업무에 필요한 다양한 방법을 익혀 활용해왔습니다. ASANA를 통한 업무 관리와 협업을 진행하고, 개발 도구와 AI를 활용해 반복 업무를 자동화하거나 작업 시간을 단축하는 등 효율적인 업무 방식을 꾸준히 고민해왔습니다.", "디자인 툴뿐 아니라 업무 관리, 파일 관리, AI 도구 등 필요한 방법을 익혀 사용해왔습니다. 작업 이후에는 실제 화면이나 결과물을 확인하면서 수정하는 편입니다.", "무엇을 보여줘야 하는지 먼저 정리합니다. 직접 제작하거나 협업으로 구현한 뒤에는 화면과 현장에서 빠진 부분을 다시 확인합니다.", "무엇을 보여줘야 하는지 먼저 정리하고, 제작이나 협업 이후에는 실제 화면과 현장에서 빠진 부분을 다시 확인합니다."] },
  contact: { titles: ["디자인에만 머무르지 않고, 기획까지 함께 할 수 있는 사람이 되고 싶습니다.", "더 자세한 작업 경험이 궁금하다면 연락 주세요.", "디자인부터 운영까지,\n해온 일을 더 보여드리겠습니다.", "디자인부터 운영까지, 더 이야기할 수 있습니다.", "다양한 실무 경험을 바탕으로 함께 일할 기회를 찾고 있습니다."], descriptions: ["단순히 주어진 디자인을 만드는 데 그치지 않고 다양한 실무 경험을 바탕으로 디자인과 기획을 함께 이해하고, 더 나아가 서비스와 콘텐츠의 전체 흐름을 주도적으로 설계할 수 있는 사람으로 성장하는 것이 목표입니다.", "디자인, 콘텐츠 제작, 쇼핑라이브, 서비스 기획과 QA 경험을 정리했습니다. 더 필요한 내용은 작업물과 함께 설명드릴 수 있습니다.", "그래픽, 콘텐츠, 커머스, 서비스 화면을 함께 다뤄온 경험이 필요하다면 작업 모음과 경력을 살펴봐 주세요.", "그래픽, 콘텐츠, 커머스, 서비스 화면까지 함께 다뤄온 경험을 작업과 경력으로 정리했습니다."] },
} as const;
