...
export const projects: Project[] = [
  {
    ...
    number: "01",
    title: "LIVBEE",
    subtitle: "쇼호스트·모델과 브랜드가 일을 시작하는 과정을 연결하는 매칭 서비스.",
    ...
    summary:
      "쇼핑라이브 현장에서 반복되던 불분명한 요청과 섭외 방식을 서비스의 흐름으로 바꿔보는 개인 프로젝트입니다. 문제 정의부터 화면 기준, 구현 검토와 브라우저 QA까지 직접 연결합니다.",
    hero: {
    ...
    sections: [
      ...
      {
        label: "Build / QA",
        title: "AI는 구현을 앞당기고, 화면 책임은 직접 확인합니다.",
        body: "IDEA → PLAN → BUILD → REVIEW → QA의 흐름으로 ChatGPT, Claude, Codex를 활용하고 GitHub와 Vercel에서 결과를 검토합니다. UX/UI의 기준과 실제 브라우저 화면 QA는 직접 맡아 기획 의도와 구현 사이의 차이를 줄입니다.",
  ...
  },
  {
    slug: "shopping-live",
    number: "02",
    title: "Shopping Live / Content",
    subtitle: "상품을 보이는 장면과 판매가 시작되는 장면 사이를 설계한 실무 경험.",
    ...
    summary:
      "제품의 특성을 읽고, 촬영과 상세페이지, 프로모션, 쇼핑라이브의 장면으로 연결해 온 경험입니다. 완성된 이미지와 방송 현장 중심으로 작업의 결과를 선별했습니다.",
    hero: {
      src: "/images/selected-works/live-commerce-banner.jpg",
      alt: "자연 풍경과 디지털 기기를 배경으로 구성된 쇼핑라이브 런칭 배너",
      ratio: "wide",
      tone: "ink",
      caption: "Shopping Live launch banner",
    },
    intro:
      "쇼핑라이브는 방송이 시작되는 순간보다 그 이전의 판단에서 많이 결정됩니다. 상품의 포인트를 확인하고, 어떤 장면과 정보가 필요한지 정리한 뒤, 상세페이지와 프로모션, 현장 운영까지 하나의 판매 맥락으로 연결했습니다.",
    sections: [
      {
        label: "Preparation",
        title: "상품을 먼저 읽고, 보여줄 순서를 만듭니다.",
        body: "제품의 특징과 사용 장면을 살펴본 뒤 판매 포인트를 정리하고, 촬영·배너·상세페이지에서 각 정보가 어떤 순서로 보여야 하는지 잡았습니다.",
        items: ["Product analysis", "Selling points", "Photo / video", "Detail page"],
      },
      {
        label: "Live operation",
        title: "콘텐츠와 현장 운영을 같은 흐름으로 봅니다.",
        body: "방송 전 프로모션부터 진행 화면, 출연자와 세팅, 제품 설명까지 끊기지 않도록 준비했습니다. 아래 자료는 그 과정에서 만들어진 배너, 현장 썸네일, 상세페이지 일부입니다.",
